...
[
 ...
 { "type": "transfer",
   ...
   "id": 2,
   "src_urls": [
     { "site_label": "condorpool_symlink", "url": "file:///work/shashwat.singh/3gsky/prod/ET/300/output/inj_8483.ini", "priority": 0, "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "condorpool_symlink", "url": "symlink://$PWD/inj_8483.ini" }
   ] }
]
eof
...
pegasus-kickstart  -n inference_ID0 -N ID0003243 -R condorpool_symlink  -s H1-INFERENCE_8483-0-10.hdf=H1-INFERENCE_8483-0-10.hdf -L gw.dax -T 2022-05-06T18:56:50+00:00 /work/shashwat.singh/cbc-hm/bin/pycbc_inference --nprocesses 1 --force  --seed 0 --config-file prior.ini inj_8483.ini --output-file H1-INFERENCE_8483-0-10.hdf
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "condorpool_symlink", "url": "file://$PWD/H1-INFERENCE_8483-0-10.hdf", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "local", "url": "file:///work/shashwat.singh/3gsky/prod/ET/300/output/local-site-scratch/work/./H1-INFERENCE_8483-0-10.hdf" }
   ] }
]
eof
